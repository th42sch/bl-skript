...
\newcommand{\drawUnivModel}[2]{%
  ...
  \node [above left= 0mm and  0mm of ell] {\Amc};
...
\newcommand{\addAprime}{%
  \node[ellipse,draw=black,thin,fit=(b) (c) (d),inner sep=0mm] (ell) {};  
}
...
Da diese Folge monoton wächst, liefert ihr Limit den gewünschten Homomorphismus
von $\Umc|_M$ nach $\Umc'$.
