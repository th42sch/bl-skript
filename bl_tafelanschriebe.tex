...
wodurch folgender unendlicher I-Baum erzeugt wird:
%
\begin{center}
  \begin{tikzpicture}[%
    >=Latex,baseline=.2pt,
    ...
    \node[state] (1)                      {};
    \node[state] (2)    [below=10mm of 1] {};
    \node[state] (3)    [below=10mm of 2] {};
    \node        (dots) [below=10mm of 3] {$\vdots$};
...
Wir betrachten folgenden I-Baum.
%
\begin{center}
  \begin{tikzpicture}[%
    >=Latex,baseline=.2pt,
